...
When a feature branch is merged into the `master` branch, a github action creates a tag and releases, and updates `CHANGELOG.md`. It then publishes the new content to docs.starknet.io.
