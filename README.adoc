...
If you are interested in contributing to Starknet technical documentation, see our link:./contributing_to_docs[resources].
...
|See link:/contributing_to_docs/contributing.adoc[Contributing to Starknet documentation] to learn more about this repository and how you can contribute.

|Are there any basic guidelines to help me?
| For basic guidelines to help us keep our content consistent link:/contributing_to_docs/doc_guidelines.adoc[Documentation guidelines] provides some.

|How do I set up my workstation?
|See xref:contributing_to_docs/setting_up_environment.adoc[]
