...
Use the guidance for link:https://developers.google.com/style/word-list#drop-down[_drop-down_ in the _Google developer documentation style guide_], even though the Red Hat style guide overrides this guidance, recommending the term _pulldown_.

*Reasoning:* The term _drop-down_ is more common than the term _pulldown_, which is recommended by the Red Hat guide.
