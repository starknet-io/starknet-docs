...
The default is to use the full word _transaction_ in normal prose.You can use _tx_ as an abbreviation for the word _transaction_ if you feel it improves readability.
