...
Use the guidance for link:https://developers.google.com/style/word-list#drop-down[_drop-down_ in the _Google developer documentation style guide_], even though the Red Hat style guide overrides this guidance.
