...
This installment of the series will therefore walk you through [running attestation service](#running-pathfinders-attestation-service).
...
Luckily, running [Software Mansions's attestation service](https://github.com/software-mansion/starknet-validator-attestation/tree/main) is as simple as running:
