...
* [Running a full node](/secure/quickstart/node-operators/running-a-node) - Setting up and maintaining your validator node

* [Becoming a validator](/secure/quickstart/node-operators/becoming-a-validator) - How to stake your tokens to become eligible for validation

* [Recommended next steps](/secure/quickstart/node-operators/next-steps) - Advanced topics and ongoing maintenance
