...
| Name | Description |
|------|-------------|
| Starknet CLI | Support for the Starknet CLI has been removed. Instead use [Starkli or Starknet Foundry's `sncast`](/learn/cheatsheets/ecosystem#core-tools). |
