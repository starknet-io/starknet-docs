...
| ----------- | ---------------- | -------------- | -------------- |
| Mainnet     | 0.14.0           | 1.7.0          | 2.0.0 - 2.12.0 |
...
| Max L2 gas per block                 | The maximum amount of L2 gas that a block can contain<br /><br />**Note:** This limit ensures block production times remains consistent and predictable.                                                                                                                    | Mainnet: 5 \* 10^9<br /><br />Sepolia: 6 \* 10^9 |
