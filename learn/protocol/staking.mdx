...
- The [Pathfinder](https://docs.swmansion.com/pathfinder/getting-started/hardware-requirements) full node with [attestation tool](https://github.com/software-mansion/starknet-validator-attestation/blob/main/README.md)
