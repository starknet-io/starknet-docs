...
<Frame caption="Figure 1: Cairo instruction (little-endian)">
  <img src="/learn/s-two/cairo-air/cairo/cairo-instruction.png" />
</Frame>
...
<Frame caption="Figure 2: New instruction format with opcode extension">
  <img src="/learn/s-two/cairo-air/cairo/opcode-extension.png" />
</Frame>
...
<Note>
Even if an instruction does not belong to any predefined set of opcodes, it is considered a valid opcode as long as it adheres to the state-transition function defined in Section 4.5 of the Cairo paper.
In S-two Cairo, this is referred to as a _generic opcode_.
</Note>
