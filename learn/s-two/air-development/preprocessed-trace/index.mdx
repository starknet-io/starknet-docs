...
For those of you who have completed the [Writing a Simple AIR](air-development/writing-a-simple-air/index.mdx) tutorial, you should now be familiar with the concept of a trace as a table of integers that are filled in by the prover (we will now refer to this as the **original trace**).
...
For those of you who are curious about why we need to commit to the trace, please refer to the [Committing to the Trace Polynomials](../simplest-air/committing-to-the-trace-polynomials.mdx) section.
