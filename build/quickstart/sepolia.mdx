...
<Note>
To learn how to fetch a predeployed Sepolia account, check out [Troubleshooting](/build/quickstart/troubleshooting/).
</Note>
...
If all goes well, the result should resemble the following (`66₁₀ = 42₁₆`):
