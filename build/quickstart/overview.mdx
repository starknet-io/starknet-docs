...
New to Starknet and want a conversational introduction before diving into the tutorial? [LearnAI's StarkNet course](https://www.uselearnai.com/course/starknet) covers STARK proofs, the Cairo language, writing and deploying contracts with Scarb and Starknet Foundry, native account abstraction, and the broader ecosystem — taught interactively by an AI tutor. Free, no account required.
