...
- **Live on mainnet:** the privacy pool contract is deployed at [`0x0403…812a`](https://voyager.online/contract/0x040337b1af3c663e86e333bab5a4b28da8d4652a15a69beee2b677776ffe812a). The contract source is readable on Voyager.
...
<CardGroup cols={2}>
  <Card title="Paper" icon="file-pdf" href="https://eprint.iacr.org/2026/474">
    _Scalable Compliant Privacy on Starknet_ (IACR ePrint 2026/474)
  </Card>
...
| **Efficient discovery** | Recipients find notes in time scaling with _their_ activity, not total pool activity. |
