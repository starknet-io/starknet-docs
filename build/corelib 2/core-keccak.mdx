...
## [Free functions](./core-keccak-free_functions)

| | |
|:---|:---|
| [keccak_u256s_le_inputs](./core-keccak-keccak_u256s_le_inputs) | Computes the Keccak-256 hash of multiple `u256`  values in little-endian format.... |
| [keccak_u256s_be_inputs](./core-keccak-keccak_u256s_be_inputs) | Computes the Keccak-256 hash of multiple `u256`  values in big-endian format.... |
| [cairo_keccak](./core-keccak-cairo_keccak) | Computes the Keccak-256 hash of a byte sequence with custom padding. This function allows hashing arbitrary byte sequences by providing the input as... |
| [compute_keccak_byte_array](./core-keccak-compute_keccak_byte_array) | Computes the Keccak-256 hash of a `ByteArray` .... |
