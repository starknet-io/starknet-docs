...
![Quick Start wallets hero](/assets/starkzap/quick-start-wallets.png)
...
```typescript
import { StarkZap, StarkSigner, Amount, fromAddress, getPresets } from "@starkware-ecosystem/starkzap";
