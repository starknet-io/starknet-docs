...
![Tx Builder hero](/assets/starkzap/tx-builder.png)
...
| `.lendDeposit(request)`                            | Lending deposit (supply) — see [Lending](/build/consumer-app-sdk/lending) |
...
| `.dcaCreate(request)`                              | Create a DCA (recurring buy) order — see [Swaps](/build/consumer-app-sdk/swap#dca-dollar-cost-averaging) |
| `.dcaCancel(request)`                              | Cancel a DCA order                             |
| `.confidentialFund(confidential, details)`          | Fund confidential account — see [Confidential](/build/consumer-app-sdk/confidential) |
...
- [Lending](/build/consumer-app-sdk/lending) — Batch deposit, withdraw, borrow, and repay with Vesu
- [Confidential Transfers](/build/consumer-app-sdk/confidential) — Fund, transfer, and withdraw with Tongo
