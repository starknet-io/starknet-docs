...
DCA support is planned for a future release. For now, you can implement scheduled swaps (e.g. via a backend or user-triggered flow) by calling `wallet.swap()` repeatedly with the desired amounts and intervals.
...
- [Bitcoin, Stablecoins, and Tokens](/build/consumer-app-sdk/erc20) — Token presets and amounts
- [Transactions](/build/consumer-app-sdk/transactions) — Execution options and fee modes
- [Tx Builder](/build/consumer-app-sdk/tx-builder) — Batching transfers and other operations
- [API Reference](/build/consumer-app-sdk/api-reference) — Full method signatures
