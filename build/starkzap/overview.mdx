...
- **Troves** - Access Troves strategies, inspect positions, and route deposits or withdrawals through the wallet
- **Privacy** - Two independent protocols: the STRK20 privacy pool hides amounts, sender, and recipient; Tongo Cash hides amounts
...
`-- Feature Modules
    ...
    +-- Troves
    |   `-- Strategies, positions, deposits and withdrawals
    +-- Privacy — STRK20 pool
    |   `-- Shielded deposit, transfer, withdraw; relayer submission
    +-- Privacy — Tongo
    |   `-- Fund, transfer, withdraw against an encrypted balance
    +-- Transaction Builder
...
- **Feature Modules** - Token ops, staking, bridging, swap and DCA, lending, Troves, transactions, type-safe primitives
- **Privacy** - Two independent protocols with no shared interface: the [STRK20 pool](/build/starkzap/privacy/strk20) spends notes and proves remotely, [Tongo](/build/starkzap/privacy/tongo) keeps an encrypted balance and proves locally
...
- [Troves](/build/starkzap/troves) - Discover strategies and deposit or withdraw through Troves
- [Privacy](/build/starkzap/privacy/overview) - Choose between two independent protocols: the [STRK20 privacy pool](/build/starkzap/privacy/strk20) hides amounts, sender, and recipient; [Tongo](/build/starkzap/privacy/tongo) hides amounts
