...
- **Confidential** - Privacy-preserving balances and transfers with Tongo
...
- [Swaps](/build/consumer-app-sdk/swap) - Exchange tokens with AVNU or Ekubo
- [Lending](/build/consumer-app-sdk/lending) - Supply, borrow, and repay with Vesu
- [Confidential Transfers](/build/consumer-app-sdk/confidential) - Privacy-preserving balances with Tongo
