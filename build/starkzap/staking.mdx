...
description: "Stake in Starknet delegation pools, claim rewards, and manage exits with the native two-step staking flow"
icon: "chart-line"
---

![Staking and Delegation hero](/assets/starkzap/staking-delegation.png)

## Overview

This page covers Starkzap support for Starknet's native delegation staking protocol. Validators run pools where delegators can stake tokens and earn rewards.

<Info>
  Looking for liquid staking (LST) via Endur? See [LST Staking](/build/starkzap/lst-staking).
</Info>
...
- Learn about [Transaction Builder](/build/starkzap/transactions#transaction-builder) for batching operations
- Explore [LST Staking](/build/starkzap/lst-staking) for liquid staking flows with `wallet.lstStaking(asset)`
