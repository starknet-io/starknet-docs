...
Starkzap supports lending and borrowing through the **[Vesu](https://vesu.xyz/lite/markets)** provider. Users can supply assets (deposit), borrow against collateral, repay debt, and withdraw supplied assets. The SDK exposes a `LendingClient` via `wallet.lending()` with chain-aware market discovery and health checks.
...
- [Tx Builder](/build/consumer-app-sdk/tx-builder) — Batching operations
