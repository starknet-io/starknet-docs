...
Before proceeding with this example, make sure that you read the [intro](/advanced-learn/architecture/account_abstraction/account_contract) to account contracts on Starknet which will help you understand how Starknet account contracts work.
