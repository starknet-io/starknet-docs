...
We will use the following SimpleStorage contract. In the [Storage Variables](/quickstart/basics/variables) page, you can find explanations for each component of the contract:
...
Only deployed instances of the contract can be interacted with. You can refer to the [How to Deploy](/quickstart/interacting/how_to_deploy) page. Note down the address of your contract, as it is needed for the following part.
