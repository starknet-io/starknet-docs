...
- Keys and values must be of valid storage types, see [Storing Custom Types](/quickstart/basics/storing_custom_types)
...
- Learn more in the [Starknet Documentation](https://docs.starknet.io/architecture-and-learn/architecture/smart-contracts/contract-storage/#storage_variables)
