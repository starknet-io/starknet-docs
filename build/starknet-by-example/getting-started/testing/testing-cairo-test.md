...
It is highly recommended to use it instead of Cairo-test, see [Testing with Snforge](/quickstart/testing/testing-snforge).
</Warning>
...
Testing is done similarly as shown in the [Testing with Snforge](/quickstart/testing/testing-snforge) section, but all the snforge specific features are not available.
