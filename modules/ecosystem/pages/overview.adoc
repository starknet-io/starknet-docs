...
[NOTE]
====
Starknet status provides timely status information about the health of Starknet sequencing, and Starknet Monitor shows vital statistics about Starknet and core infrastructure.
====
