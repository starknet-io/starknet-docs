...
[IMPORTANT]
====
The Starknet Improvement Proposal (SNIP) for Bitcoin staking on Starknet is now https://community.starknet.io/t/staking-upgrade-bitcoin-becoming-a-validator/115696[live^]!
