...
* https://go.dynamic.xyz/4eFmNMI[Dynamic SDK] is a wallet connection kit, built by https://www.dynamic.xyz/[Dynamic], that enables multi-chain wallet connections.
