...
<<<<<<< HEAD:components/Starknet/modules/resources/pages/version-notes.adoc
== Starknet v0.14.0 (Pre-release)

Starknet v0.14.0 is scheduled for Testnet on July 2 2025 and for Mainnet on July 28 2025.
...
>>>>>>> main:modules/resources/pages/version-notes.adoc
