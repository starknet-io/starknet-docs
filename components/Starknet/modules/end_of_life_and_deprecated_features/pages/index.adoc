...
|===
|Name|Description
|Cairo version 0 | xref:starknet_versions:version_notes.adoc#version0.11.0[Starknet v0.11.0] introduces Cairo 1.0 smart contracts.
|===
...
From Starknet xref:starknet_versions:version_notes.adoc#version0.11.0[version 0.11.0], the fee mechanism is enforced and the ability to send L1->L2 messages without the corresponding L2 fee has been removed.
