...
## v0.4.3
The primary purpose of this release is to properly support testnet2 after the xref:general:release-notes.adoc#version0.10.3[Starknet v0.10.3] update.
...
This release contains a breaking change, and also adds support for xref:general:release-notes.adoc#version0.10.2[Starknet v0.10.2].
