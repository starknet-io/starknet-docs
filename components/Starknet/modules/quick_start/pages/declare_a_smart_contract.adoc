...
However, because Starkli and Scarb are not always in sync, the Scarb compiler version might be greater than `2.5.4`. You can check by running the following command:
