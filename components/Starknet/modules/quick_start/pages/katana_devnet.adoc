...
For the full list of account addresses, see the constant link:https://github.com/xJonathanLEI/starkli/blob/master/src/account.rs#L76[`BUILTIN_ACCOUNT` in `accounts.rs`] in the Starkli GitHub repo.
