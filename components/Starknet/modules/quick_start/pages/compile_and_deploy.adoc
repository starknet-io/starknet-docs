...
For more information, see the xref:set_up_an_account.adoc[Setting up a smart wallet] section.

=== Set up your account

Complete the steps outlined in the xref:deploying_an_account.adoc[Setting up an account] section before attempting to deploy a smart contract.
