...
[TIP]
====
This guide shows you how to set up a Starknet wallet in the context of a smart contract deployment.
...
Currently, the `fetch` command supports both Argent X and Braavos smart wallets. Make sure your wallet address is already deployed and input following command to create and save the account descriptor file:
