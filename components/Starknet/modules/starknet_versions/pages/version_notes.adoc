...
==== Sequencer performance improvements
...
==== Block hash syscall
In v0.12.0, a new syscall will be added that will allow contracts to fetch the block hashes of older blocks.


==== Smart contract syntax improvements
In Starknet version 0.12.0, significant improvements to the smart contract syntax are introduced. The new syntax focuses on:

* Contract safety.
* Laying the foundations for extensibility.

==== Upgrade of Cairo to v2.0.0.
In Starknet version 0.12.0, Cairo has been upgraded to version 2.0.0.
