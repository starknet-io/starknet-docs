...
* Papyrus, an open-source Rust implementation of a Starknet full node integrated into Starknet's infrastructure.
...
You can read more about the major features of this version in more detail on the xref:starknet-0-12-0-features.adoc[Starknet v0.12.0 overview page].
