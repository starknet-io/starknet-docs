...
Starknet v0.12.2 is live on testnet.
...
** Restrict access to `sequencer_address` in the `get_execution_info` syscall by returning zero values for the `sequencer_address`.
