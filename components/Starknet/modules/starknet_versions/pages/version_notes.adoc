...
The following release notes cover the ongoing version changes to Starknet. To get the latest version updates delivered to your inbox, please subscribe to our link:https://cdn.forms-content.sg-form.com/2fb14a4a-f24d-11ed-97a1-2255cc459392[mailing list].
...
|Mainnet|0.12.2|1.3.0|2.0.0 - 2.3.0-rc0
|Goerli Testnet 1|0.12.2|1.3.0|2.0.0 - 2.3.0-rc0
|Goerli Testnet 2|0.12.2|1.3.0|2.0.0 - 2.3.0-rc0
|===
