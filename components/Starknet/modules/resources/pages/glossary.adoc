...
* link:https://docs.starknet.io/components-and-concepts/smart-contracts/cairo-and-sierra/[Cairo and Sierra]
...
The Cairo program that, upon receiving a set of transaction as input, executes the state transition. For more information, see xref:components-and-concepts:state/[Starknet state]. The integrity of this computation is what is actually proven and verified.
...
* xref:components-and-concepts:state/[Starknet state]
...
* xref:components-and-concepts:transactions.adoc#transaction_types[Transaction types]
* xref:components-and-concepts:state.adoc[Starknet state]
