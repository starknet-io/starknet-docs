...
The Cairo program that, upon receiving a set of transaction as input, executes the state transition. For more information, see xref:architecture-and-concepts:state/[Starknet state]. The integrity of this computation is what is actually proven and verified.
...
* xref:architecture-and-concepts:state/[Starknet state]
...
* xref:architecture-and-concepts:transactions.adoc#transaction_types[Transaction types]
* xref:architecture-and-concepts:state.adoc[Starknet state]
