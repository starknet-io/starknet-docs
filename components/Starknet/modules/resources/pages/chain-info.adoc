...
| Max builtin invocations per block
| The maximum amount of builtin invocations that a block can contain, for each builtin
| None (builtin tracking is not yet implemented on Mainnet)

| Range Check: 28,571,428 
...
See xref:architecture-and-concepts:messaging.adoc#l1-l2-message-fees[here] for more details.
