...
|Sepolia Testnet|0.13.4|1.7.0|2.0.0 - 2.10.0
|===
...
|Starknet CLI | Support for the Starknet CLI has been removed. Instead use xref:tools:devtools/interacting-with-starknet.adoc[Starkli or Starknet Foundry's `sncast`].
