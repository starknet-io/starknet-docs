...
<div class="home-cta-container">
  <a href="https://docs.starknet.io/documentation/quick_start/environment_setup/" class="home-cta home-cta-first" id="cta1">
    ...
    <p class="chakra-card__body css-jintet"><b>Explore ></b></p>
  </a>
...
[pass]
====
// JavaScript to switch images when the data-theme attribute is "dark"
...
// Check the current data-theme attribute value
const currentTheme = themeSwitch.getAttribute('data-theme');

  if (currentTheme === 'dark') {
    // If the theme is "dark," switch to dark images
    image1.src = '_images/developers_dark.svg';
    image2.src = '_images/how_SN_works_dark.svg';
    image3.src = '_images/dark_image3.png';
  } else {
    // If the theme is not "dark," switch back to light images
