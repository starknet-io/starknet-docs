...
* Review these link:https://github.com/starknet-io/starknet-docs/blob/dev/contributing_to_docs/doc_guidelines.adoc[basic writing guidelines] help you write better and be part of the team.
* Use the link:https://github.com/starknet-io/starknet-docs/blob/dev/contributing_to_docs/starknet_docs_style_guide.adoc[The Starknet documentation supplementary style guide]. It includes style guidance to help you write more efficiently and consistently using the Starknet voice.
