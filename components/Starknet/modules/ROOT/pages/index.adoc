...
* link:https://github.com/starknet-io/starknet-docs/blob/dev/README.adoc#different_ways_to_contribute[Different ways to contribute].
* link:https://github.com/starknet-io/starknet-docs/blob/dev/contributing_to_docs/doc_guidelines.adoc[Basic writing guidelines] help you write better and be part of the team.
* link:https://github.com/starknet-io/starknet-docs/blob/dev/contributing_to_docs/starknet_docs_style_guide.adoc[The Starknet documentation supplementary style guide] includes style guidance to help you write more efficiently and consistently using the Starknet voice.
