...
link: https://github.com/starkware-libs/cairo/blob/main/corelib/src/starknet/secp256r1.cairo#L73[`secp256r1_new_syscall`]

[discrete]
=== Example for `secp256r1_new_syscall`
...
link: https://github.com/starkware-libs/cairo/blob/main/corelib/src/starknet/secp256r1.cairo#L73[`secp256r1_add_syscall`]

[discrete]
=== Example for `secp256r1_add_syscall`
...
[discrete]
=== Example for secp256r1_mul_syscall
...
[id="secp256r1_get_point_from_x_syscall"]
...
Recovers a point on the curve given its x-coordinate and y-parity. Since the curve equation has two solutions for y given x, the y_parity parameter determines which y value to use.
...
[discrete]
=== Example for `secp256r1_get_point_from_x_syscall`
...
[horizontal,labelwidth=35]
`_p_: Secp256r1Point`:: The point whose coordinates are to be retrieved.
...
[discrete]
=== Example for `secp256r1_get_xy_syscall`
