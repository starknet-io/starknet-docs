...
This system call is particularly useful when implementing cryptocurrency-related functionality, as secp256k1 is widely used in Bitcoin, Ethereum, and other blockchain systems.
...
Note that instead of using this syscall directly, it is recommended to use the functions provided in link:https://github.com/starkware-libs/cairo/blob/main/corelib/src/starknet/secp256k1.cairo[`secp256k1.cairo`] which provide a more convenient interface and handle the syscall under the hood.
...
link:https://github.com/starkware-libs/cairo/blob/67c6eff9c276d11bd1cc903d7a3981d8d0eb2fa2/corelib/src/starknet/secp256k1.cairo[`secp256k1.cairo`^]

[discrete]
=== Example

The following example demonstrates how to create and validate a point on the secp256k1 curve using the recommended functions from link:https://github.com/starkware-libs/cairo/blob/67c6eff9c276d11bd1cc903d7a3981d8d0eb2fa2/corelib/src/starknet/secp256k1.cairo[`secp256k1.cairo`^]:

[source,cairo]
----
use starknet::secp256k1::Secp256k1Point;

// Known valid point coordinates on secp256k1 curve
