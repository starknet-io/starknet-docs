...
The event hashes are included in the xref:network-architecture/header.adoc[`event_commitment`] field of a block.
...
* The `event_commitment` field in xref:network-architecture/header.adoc[]