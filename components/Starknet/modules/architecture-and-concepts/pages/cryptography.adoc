...
the number of points stem:[n] on the STARK curve is the prime order (the curve has cofactor stem:[h]=1):
* stem:[n] = 3618502788666131213697322783095070105526743751716087489154079457884512865583

the generator point stem:[G] used in the ECDSA scheme is defined by:
