...
For more details, see the link:https://github.com/starknet-io/SNIPs/blob/main/SNIPS/snip-1.md#snip-editor-responsibilities[SNIP Editor Responsibilities]. The SNIP current editors (with their GitHub handles) are:
