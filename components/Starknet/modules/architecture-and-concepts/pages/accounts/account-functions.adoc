...
[WARNING]
====
At the moment of writing (Starknet 0.13.2), two critical validations must happen in `+__execute__+`, and their absense can lead to draining of the account's funds:
