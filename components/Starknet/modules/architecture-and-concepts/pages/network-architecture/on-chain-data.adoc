...
** `contract_address` - the xref:smart-contracts/contract-address[address]  of the deployed contract. See also xref:network-architecture/on-chain-data.adoc[Data availability].
...
** `contract_address` - the xref:../network-architecture/on-chain-data.adoc[address] of the contract
