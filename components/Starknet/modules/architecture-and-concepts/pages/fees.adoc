...
*  `l1_data_gas_price` is the average of the last 60 L1 base data gas prices sampled by the Starknet sequencer every 60 seconds, divided by a scaling factor that approximate for the average rate compression achieved from posting the data to Ethereum
