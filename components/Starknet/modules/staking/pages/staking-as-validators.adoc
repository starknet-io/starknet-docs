...
To update the commission rate of your delegation pool, use your operational address to invoke the staking contract's `update_commission` function with the new commission rate as parameter. The comission rate should be expressed as a percentage with precision, where 10,000 represents 100%. For example, you can use the following to change the commission rate to 1% on Sepolia:
