...
. Register your validator on the staking dashboards, link:https://forms.gle/WJqrRbUwxSyG7M9x7[Voyager], link:https://stakingrewards.typeform.com/to/aZdO6pW7[Staking Rewards], link:https://forms.gle/BUMEZx9dpd3DcdaT8[Karnot].

and link:https://stakingrewards.typeform.com/to/aZdO6pW7[claiming your staking rewards provider profile].
