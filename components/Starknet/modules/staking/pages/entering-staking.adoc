...
* A Starknet-compatible xref:tools:ref-block-explorers.adoc[block explorer] or link:https://book.starkli.rs[CLI tool].
...
.. Navigate to the STRK contract by searching for xref:chain-info.adoc#important_addresses[its address]
