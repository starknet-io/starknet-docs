...
For information on the movement of funds between Ethereum and Starknet, see xref:starkgate-bridge.adoc
...
https://github.com/starkware-libs/starkgate/blob/dev/src/solidity/StarkgateConstants.sol
