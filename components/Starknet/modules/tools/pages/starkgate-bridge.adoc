...
The tokens that StarkGate supports are listed in JSON files in the Starknet Github repository, as shown in the table xref:#table_StarkGate_token_addresses[].
