...
* Adding a token that requires a customized bridging mechanism or a non-standard ERC-20 contract on L2 is currently not permissionless, and can be done only by the StarkWare team. Please contact StarkWare on the link:https://community.starknet.io/[Starknet Community Forum] and link:https://discord.com/invite/qypnmzkhbc[Discord channel].
