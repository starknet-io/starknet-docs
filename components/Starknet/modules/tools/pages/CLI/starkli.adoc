...
xref:CLI/commands.adoc[Starknet CLI], the current command line interface (CLI) for Starknet, built by StarkWare, is deprecated, and support will be removed in Starknet v0.13.0.
