...
SDKs implement the Starknet link:https://github.com/starkware-libs/starknet-specs[JSON RPC sepcification], and are updated to supporte the latest API changes. There are SDKs for various languages, so you can choose the SDK according to your needs.
