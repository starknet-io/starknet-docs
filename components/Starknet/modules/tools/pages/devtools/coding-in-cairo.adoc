...
https://www.stark-utils.xyz/converter[Stark-utils^] is a simple web application that aims to be a toolbox for Cairo developpers, allowing you to convert any input to a felt, string, hexadecimal value, etc.
