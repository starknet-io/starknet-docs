...
|https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarkgateManager.sol[`StarkgateManager.sol`] |The StarkGate Manager.

Use the Manager to enroll a new token.

An interface is available through https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/IStarkgateManager.sol[`IStarkgateManager.sol`]. a| * xref:#enrollTokenBridge[`enrollTokenBridge`]
|https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarkgateRegistry.sol[`StarkgateRegistry.sol`] a|The StarkGate Registry.

Use the Registry to view the addresses of existing bridges and to stop servicing a specific token.

An interface is available through https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/IStarkgateRegistry.sol[`IStarkgateRegistry.sol`].
a| * xref:#getBridge[`getBridge`]
* xref:getWithdrawalBridges[`getWithdrawalBridges`]

|https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol[`StarknetTokenBridge.sol`] |The primary StarkGate bridge contract. The functions and events in this reference that provide the main user bridge functionality are defined in this contract. a|
...
|https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/IStarkgateService.sol[`IStarkgateService.sol`] | An interface to check if a contract is servicing a token. a|
...
|https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/cairo/token_bridge.cairo[`token_bridge.cairo`] |The StarkGate bridge implementation on L2. This contract includes the standard functions for a token bridge.

An interface is available through https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/cairo/token_bridge_interface.cairo[`token_bridge_interface.cairo`]. a|
...
Contract: link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol[`StarknetTokenBridge.sol`]

* Function: link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol#L284[`deposit`]
* Event: link:[`Deposit`]
...
Contract: https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol[`StarknetTokenBridge.sol`]

* Function: link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol#L515[`depositCancelRequest`]
* Event: link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol#L73[`DepositCancelRequest`]
...
* Function: link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol#L588[`depositReclaim`]
* Event: link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol#L80[`DepositReclaimed`]
...
* Function: link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol#L255[`depositWithMessage`]
* Event: link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol#L37[`DepositWithMessage`]
...
* Function: link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol#L534[`depositWithMessageCancelRequest`]
* Event: link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol#L46[`DepositWithMessageCancelRequest`]
...
* Function: link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol#L564[`depositWithMessageReclaim`]
* Event: link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol#L54[`DepositWithMessageReclaimed`]
...
[horizontal]
Contract: link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarkgateManager.sol[`StarkgateManager.sol`] ::

Function: link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarkgateManager.sol#L132[`enrollTokenBridge`] in `StarkgateManager.sol`

Contract: link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol[`StarknetTokenBridge.sol`]::
Event: link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol#L34[`TokenEnrollmentInitiated`]
...
link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol#L142C28-L142C28[`estimateDepositFeeWei`] in `StarknetTokenBridge.sol`
...
link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol#L146[`estimateEnrollmentFeeWei`] in `StarknetTokenBridge.sol`
...
link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarkgateManager.sol#L24[`getRegistry`] in `StarkgateManager.sol`
...
link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol#L198C23-L198C23[`getStatus`] in `StarknetTokenBridge.sol`
...
link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarkgateRegistry.sol#L110[`getWithdrawalBridges`] in `StarkgateRegistry.sol`.
...
[discrete]
==== Function definition
link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol#L92[`identify`] in `StarknetTokenBridge.sol`
...
link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/IStarkgateService.sol#L9C14-L9C30[`isServicingToken`] in `IStarkgateService.sol`.
...
* Function: link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol#L481[`withdraw`]
* Event: https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarknetTokenBridge.sol#L62[`Withdrawal`]
...
* Contract: link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/solidity/StarkgateConstants.sol[StarkgateConstants.sol]
...
link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/cairo/token_bridge.cairo#L376-L378[`get_erc20_class_hash`] in `token_bridge.cairo`.
...
link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/cairo/token_bridge_interface.cairo#L8C7-L8C7[`get_identity`] in `token_bridge_interface.cairo`.
...
link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/cairo/token_bridge_interface.cairo#L9C11-L9C11[`get_l1_token_address`] in `token_bridge_interface.cairo`.
...
link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/cairo/token_bridge_interface.cairo#L10[`get_l2_token_address`] in `token_bridge_interface.cairo`.
...
link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/cairo/token_bridge_interface.cairo#L11C15-L11C15[`get_remaining_withdrawal_quota`] in `token_bridge_interface.cairo`
...
link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/cairo/token_bridge_interface.cairo#L7[`get_version`] in `token_bridge_interface.cairo`.
...
link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/cairo/token_bridge_interface.cairo#L12[`initiate_withdraw`] in `token_bridge_interface.cairo`.
...
link:https://github.com/starknet-io/starkgate-contracts/tree/v2.0/src/cairo/receiver_interface.cairo#L6[`on_receive`] in `receiver_interface.cairo`.
