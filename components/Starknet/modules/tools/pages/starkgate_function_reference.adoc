...
#interface and implementation shold be in the same row. The interface is not a contract. In fucntion ref, Change the referecne to the internface.sol to the implemntation.sol. Remove interanl only functions.#
