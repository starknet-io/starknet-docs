...
`false`::  The recipient L2 contract of the `DepositWithMessage` function does not accept the funds on L2, or the `on_receive` function is not implemented in the recipients's smart contract.
