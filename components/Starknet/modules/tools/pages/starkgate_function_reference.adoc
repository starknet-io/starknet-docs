...
|https://github.com/starkware-libs/starkgate/blob/dev/src/solidity/IStarkgateManager.sol[`IStarkgateManager.sol`] |The StarkGate Manager API a|
* `deactivateToken`
* `blockToken`
* `enrollTokenBridge`

|https://github.com/starkware-libs/starkgate/blob/dev/src/solidity/StarkgateManager.sol[`StarkgateManager.sol`] |The StarkGate Manager implementation | Implementations of the functions in `IStarkgateManager.sol`.
|https://github.com/starkware-libs/starkgate/blob/dev/src/solidity/IStarkgateRegistry.sol[`IStarkgateRegistry.sol`] |The StarkGate Registry API a|
* `getBridge`
* `enlistToken`
* `deactivateToken`
* `blockToken`
...
|https://github.com/starkware-libs/starkgate/blob/dev/src/solidity/StarkgateRegistry.sol[`StarkgateRegistry.sol`] |The StarkGate Registry implementation | Implementations of the functions in `IStarkgateRegistry.sol`.
...
|https://github.com/starkware-libs/starkgate/blob/dev/src/solidity/StarknetERC20Bridge.sol[`StarknetERC20Bridge.sol`] a|
The StarkGate ERC-20 bridge contract. This contract implements all currently supported ERC-20 tokens in the multi-token bridge, as well as all the single ERC-20 bridges, such as WBTC and USDC.

This contract is an implementation of https://github.com/starkware-libs/starkgate/blob/dev/src/solidity/StarknetTokenBridge.sol[`StarknetTokenBridge.sol`].

| Inherits from `StarknetTokenBridge.sol`.
|https://github.com/starkware-libs/starkgate/blob/dev/src/solidity/StarknetEthBridge.sol[`StarknetEthBridge.sol`] a|
The StarkGate ETH bridge.
...
|https://github.com/starkware-libs/starkgate/blob/dev/src/cairo/token_bridge.cairo[`token_bridge.cairo`] |The StarkGate multi-token bridge implementation on L2. a|
* `get_erc20_class_hash`

|https://github.com/starkware-libs/starkgate/blob/dev/src/cairo/token_bridge_interface.cairo[`token_bridge_interface.cairo`] |The StarkGate multi-token bridge interface on L2. a|
* `get_identity`
...
'''
[#addExistingBridge]
=== [.code_heading]`addExistingBridge`
