...
[horizontal,labelwidth="25",role=stripes-odd]
`l1_token`:: #The L1 address of the ERC-20 token contract.#
...
#Deprecated. Use xref:#initiate_token_withdraw[]#.

Previous version of `initiate_token_withdraw`, for a single-token bridge.
