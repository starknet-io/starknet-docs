...
Blockifier-related constants and limits are defined, starting from Starknet version v0.13.0, in a link:https://github.com/starkware-libs/blockifier/tree/main/crates/blockifier/resources[dedicated file].
