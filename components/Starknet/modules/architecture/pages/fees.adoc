...
[NOTE]
====
Starknet does not currently implement burning of fees, and all fees charged are recieved by the sequencer.
====
...
* stem:[\text{tip}] is the tip specified by the transaction, starting from Starknet v0.14.0 (until then stem:[\text{tip} = 0])
