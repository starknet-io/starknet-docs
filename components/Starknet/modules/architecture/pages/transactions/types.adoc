...
hash is computed
* `compiled_class_hash` is the hash of the xref:general:upcoming-versions.adoc#what_to_expect[compiled class]
...
| `compiled_class_hash` | `FieldElement` | The hash of the compiled class (see xref:general:upcoming-versions.adoc#what_to_expect[here] for more information)
...
Since xref:general:release-notes.adoc#version0.10.1[StarkNet v0.10.1] the `DEPLOY_ACCOUNT`
