...
The fee itself is calculated in the xref:transactions/fees.adoc#overall_fee[same manner] as
"regular" L2 transactions. You can use the xref:tooling:legacy-cli-reference.adoc#starknet-estimate_fee[CLI] to get an estimate of an L1 -> L2 message fee.
...
* xref:smart-contracts/system-calls-cairo1.adoc#send_message_to_L1[`send_message_to_L1`] syscall
