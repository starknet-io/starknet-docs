...
For information on the messaging mechanism, see xref:architecture:network-architecture/l1<>l2-messaging.adoc[Messaging mechanism].
...
`uint256 _toAddress_`:: The address of the L2 contract.
`uint256 _selector_`::
include::functions-and-events-reference.adoc[tag=uint256_selector]
`uint256[] calldata _payload_`:: The payload of the message.
