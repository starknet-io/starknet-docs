...
include::functions-and-events-reference.adoc[tag=address_token]
`uint256 _amount_`::
include::functions-and-events-reference.adoc[tag=uint256_amount_deposit]
`uint256 indexed _l2Recipient_`::
include::functions-and-events-reference.adoc[tag=uint256_l2Recipient]
...
include::functions-and-events-reference.adoc[tag=uint256_l2Recipient]
`uint256 _nonce_`::
include::functions-and-events-reference.adoc[tag=uint256_nonce]
...
include::functions-and-events-reference.adoc[tag=uint256_l2Recipient]
`uint256[] _message_`::
include::functions-and-events-reference.adoc[tag=calldata_message]
`uint256 _nonce_`:: The nonce for the L1 transaction.
`uint256 _fee_`:: The Starknet fee sent with the transaction.
...
include::functions-and-events-reference.adoc[tag=address_recipient]
`address indexed _token_`::
include::functions-and-events-reference.adoc[tag=address_token]
`uint256 _amount_`::
include::functions-and-events-reference.adoc[tag=uint256_amount_withdrawal]
