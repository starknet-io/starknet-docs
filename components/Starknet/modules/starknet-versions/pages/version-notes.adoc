...
* Receipts will contain a new property `total_gas_consumed`, only for transaction after 0.13.2.
...
* End of support for the endpoints `get_block_traces` and `get_transaction_trace`.

==== JSON RPC

No changes in 0.13.2. The new JSON RPC version 0.8.0 will be released alongside Starknet 0.13.3.
