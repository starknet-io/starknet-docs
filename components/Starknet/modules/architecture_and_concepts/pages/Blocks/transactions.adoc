...
`v0` is deprecated and will be removed in a future release of Starknet.
...
`v1`, used to declare Cairo 0 classes, is deprecated and will be removed in a future Starknet version.
...
There is no `v0`. The versioning for the `deploy_account` transaction started with `v1`.
