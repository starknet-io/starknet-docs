...
Before exploring this topic, review the xref:Network_Architecture/starknet_architecture_overview.adoc[] for foundational knowledge. Familiarity with concepts such as sequencers, provers, SHARP, and SHARP jobs is assumed.
...
MerkleStatementContract:: 0x3e6118da317f7a433031f03bb71ab870d87dd2dd
