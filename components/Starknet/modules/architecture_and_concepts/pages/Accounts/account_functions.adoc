...
== Attack prevention: Limitations of validation
...
[NOTE]
====
You can access the transaction hash and value for `max_fee` by getting transaction info wit the `get_execution_info` system call.
====
