...
:description: How economics work in a block chain in general, and specifically in Starknet. The purpose of the Starknet token, it's supply and distribution.
:keywords: tokenomics, STRK
