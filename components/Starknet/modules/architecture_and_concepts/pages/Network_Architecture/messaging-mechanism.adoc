...
// Is this what a transaction is? A message?
by calling the xref:Smart_Contracts/system-calls-cairo1.adoc#send_message_to_L1[`send_message_to_L1`] syscall.
...
Contracts on L1 can interact asynchronously with contracts on L1 using the _L1→L2_ messaging protocol.
...
* https://github.com/starkware-libs/cairo-lang/blob/4e233516f52477ad158bc81a86ec2760471c1b65/src/starkware/starknet/common/messages.cairo#L4[`send_message_to_L1`] in the source contract
