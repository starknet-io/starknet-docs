...
// #What does this mean: "upon receiving enough L1 confirmations..."? Is this talking about waiting for a batch?#
...
* link:https://book.cairo-lang.org/ch16-04-L1-L2-messaging.html[L1-L2 Messaging] in _The Cairo Book: The Cairo Programming Language_