...
include::partial$snippet_transaction_depr_unsupport_notice.adoc[tag=deprecated_tx_notice]
...
include::partial$snippet_transaction_depr_unsupport_notice.adoc[tag=unsupported_tx_notice]
