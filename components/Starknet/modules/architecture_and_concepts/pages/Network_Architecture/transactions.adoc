...
| `compiled_class_hash` | `FieldElement` | The hash of the compiled class (see xref:starknet_versions:upcoming_versions.adoc#what_to_expect[here] for more information)
...
For more information, see xref:Accounts/deploying_new_accounts.adoc[].
