...
Today, the user signs the compiled class hash as part of a xref:Network_Architecture/transactions.adoc#declare_v2[declare v2] transaction. If the transaction is included in a block, then the compiled class hash becomes part of the commitment.
