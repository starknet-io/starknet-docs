 ...
 ** `contract_address` - the xref:Network_Architecture/Data_Availability/on-chain-data.adoc[address] of the deployed contract
 ...
 ** `contract_address` - the xref:Network_Architecture/Data_Availability/on-chain-data.adoc[address] of the contract
