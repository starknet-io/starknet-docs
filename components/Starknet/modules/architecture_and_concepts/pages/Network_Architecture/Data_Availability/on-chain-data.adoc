...
xref:documentation:architecture_and_concepts:Network_Architecture:Blocks/transactions.adoc#declare_v2[declare v2] in this state update, and the next two elements
encode
xref:architecture_and_concepts:Smart_Contracts/class-hash.adoc[the class hash] and
 ...
 ** `contract_address` - the xref:architecture_and_concepts:Smart_Contracts/contract-address.adoc[address] of the deployed contract
 ** `contract_hash` - the xref:architecture_and_concepts:Smart_Contracts/class-hash.adoc[hash] of the class
* Number of contracts whose storage is updated
* For each such contract, we have:
 ** `contract_address` - the xref:architecture_and_concepts:Smart_Contracts/contract-address.adoc[address] of the contract
