...
Every 60 seconds, Starknet samples the price of gas and data gas on L1 and bases the price it charges on the average of the last 60 samples.

Each gas price sample is based on the base price of gas in the last block plus 1 gwei as tip.

Each data gas price sample is based on the value of `excess_blob_gas`. For more information, see link:https://github.com/ethereum/EIPs/blob/master/EIPS/eip-4844.md[EIP-4844].
