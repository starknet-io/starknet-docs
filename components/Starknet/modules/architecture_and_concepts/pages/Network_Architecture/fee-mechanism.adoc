...
* stem:[$k$] enumerates the Cairo resource components, that is, xref:#calculation_of_computation_costs[the number of #Cairo# steps and builtins used].
...
* stem:[$n$] is xref:#storage_updates[#the number of# unique contract updates].
