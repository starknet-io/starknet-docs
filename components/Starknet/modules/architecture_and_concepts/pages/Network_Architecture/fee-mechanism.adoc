...
It's important to realize that the division to builtins must be predetermined. We can't decide on the fly to have proof with 20,000,001 Pedersen and nothing else.
