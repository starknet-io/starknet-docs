...
[NOTE]
====
The Cairo 0 compiler is no longer maintained. For more information on compiling Cairo 1 contracts
compilation, see link:https://github.com/starkware-libs/cairo#compiling-starknet-contracts[Compiling Starknet contracts] in the Cairo Git repository.
====
