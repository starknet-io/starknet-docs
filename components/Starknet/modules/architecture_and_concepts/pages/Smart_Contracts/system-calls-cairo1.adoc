...
For more information, and for a higher-level syntax for emitting events, see xref:architecture_and_concepts:Smart_Contracts/Events/starknet-events.adoc[Starknet events].
