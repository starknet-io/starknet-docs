...
*** L1-L2 messaging
**** xref:Network_Architecture/messaging-mechanism.adoc[L1-L2 messaging mechanics]
**** xref:Network_Architecture/messaging-reference.adoc[L1-L2 messaging reference]
