...
By now you successfully declared, deployed, and interacted with the `HelloStarknet` both on Starknet Sepolia and locally (way to go!). This last installment of the series will therefore only list possible next steps for you to take:
