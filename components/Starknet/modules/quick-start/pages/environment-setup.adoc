...
Installing Scarb with `asdf` seamlessly integrates with the Cairo VSCode extension, and allows to easily switch between different versions of Scarb, globally or per project.
