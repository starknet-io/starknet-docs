...
[TIP]
====
To learn more about destinction between deploying a contract and declaring it, see xref:architecture-and-concepts:smart-contracts/contract-classes.adoc[].
====
