...
* `commitment_version` and `leaf_version` are news field added to allow forward compatability and are currently set to 0
* `h` is the link:Poseidon hash function
