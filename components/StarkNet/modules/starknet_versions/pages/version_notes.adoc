...
The current versions on each environment are listed within the table below:
...
[id="version0.11.0"]
== Starknet v0.11.0 (Currently on Goerli Testnets only)

Starknet v0.11.0 will be released on Mainnet once the Goerli testing period has been completed.
