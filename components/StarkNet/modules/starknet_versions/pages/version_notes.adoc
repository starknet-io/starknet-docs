...
The current configurations for each environment are listed within the table below:
...
[id="version0.11.0"]
== Starknet v0.11.0 (March 21st, 23 - Goerli testnets)

See the link:upcoming_versions.adoc[upcoming versions] section for more details.
