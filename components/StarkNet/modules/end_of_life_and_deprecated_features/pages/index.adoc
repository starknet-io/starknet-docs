...
|End of life|StarkNet Deploy has been removed in xref:ROOT/version_notes/#versions[version 0.10.3] of StarkNet. To deploy new contract instances, you can use the deploy syscall. For more information, see contract classes. 
|===