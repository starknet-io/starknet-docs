...
|L2 -> L1 messaging |Previously, sending a message from L2 to L1 was feeless.

From StarkNet version 0.11.0 a fee for this messaging mechanism will be introduced.
