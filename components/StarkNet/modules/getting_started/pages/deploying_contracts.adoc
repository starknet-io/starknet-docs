...
In order to interact with the Starknet Mainnet or any Testnets, you'll need an RPC provider.

Please refer to https://docs.alchemy.com/reference/starknet-api-quickstart/?a=starknet-docs[Alchemy's quickstart guide] to start developing with Starknet APIs.
