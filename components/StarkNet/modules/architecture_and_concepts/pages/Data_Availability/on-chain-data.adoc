...
[stem]
++++
\underbrace{0}_{\text{127 bits}} |\underbrace{\text{class information flag}}_{\text{1 bit}} |
...
means that we had a single xref:documentation:architecture_and_concepts:Blocks/transactions.adoc#_declare_transaction_version_2
[declare v2] in this state update, and the next two elements
encode
