...
means the we had a single xref:documentation:architecture_and_concepts:Blocks/transactions.adoc#_declare_transaction_version_2[declare v2] in this state update, and the next two elements
encode
