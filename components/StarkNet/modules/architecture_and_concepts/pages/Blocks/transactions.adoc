...
Note that new Cairo 1.0 classes can only be declared via the declare v2 transaction.

=== Declare transaction version 2
...
| `contract_class` | `ContractClass` | The (Cairo 1.0) xref:documentation:architecture_and_concepts:class-hash.adoc#definition_of_a_cairo_1_class[class].
...
=== Declare transaction versions 0,1
