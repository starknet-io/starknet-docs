...
++++
\begin{aligned}
\text{declare_v1_tx_hash} = h( & ``\text{declare"}, \text{version}, \text{sender_address}, 0, h(\text{class_hash}), \text{max_fee}, \text{chain_id}, \text{nonce})
\end{aligned}
++++
...
++++
\begin{aligned}
\text{declare_v0_tx_hash} = h( & ``\text{declare"}, \text{version}, \text{sender_address}, 0, h(0), \text{max_fee}, \text{chain_id}, \text{class_hash})
\end{aligned}
++++
