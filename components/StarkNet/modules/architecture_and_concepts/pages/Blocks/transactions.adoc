...
[IMPORTANT]
====
Invoke transaction v0 is no longer supported for new transactions, please use v1.

However,
you can still use invoke v0 for existing transactions.
====
...
// ToDo: Add V2 declare details here
...
// Todo: Add deploy_account tx hash
