...
[IMPORTANT]
====
Transaction version 0 has now been removed and is no longer supported. Please use version 1 or 2 instead.
====

=== Invoke transaction version 2
...
=== Calculating the hash of a v2 invoke transaction

//Todo: Add v2 version of this here
