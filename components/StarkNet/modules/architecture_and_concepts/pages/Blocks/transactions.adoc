...
* stem:[$h$] is the xref:documentation:architecture_and_concepts:Hashing/hash-functions.adoc#hash_functions[Poseidon hash function] in the class hash link, linked specifically to the
hash of a Cairo 1 class
