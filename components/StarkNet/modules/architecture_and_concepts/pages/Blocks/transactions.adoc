...
* stem:[$h$] is the
xref:documentation:architecture_and_concepts:Hashing/hash-functions.adoc#poseidon_hash[Poseidon hash function] in the class hash link, linked specifically to the
