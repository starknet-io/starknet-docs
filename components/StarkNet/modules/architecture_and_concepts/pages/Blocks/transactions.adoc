...
transaction fee (see xref:documentation:architecture_and_concepts:Account_Abstraction
/deploying_new_accounts.adoc[here] for more details).. You can then invoke the `deploy_account`
transaction.
