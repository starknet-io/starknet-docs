...
contract instances, you can use the xref:Smart_Contracts/system-calls.adoc#deploy[deploy syscall].
====
...
transaction fee (see xref:Starknet_Accounts/deploying_new_accounts.adoc[here] for more details)
