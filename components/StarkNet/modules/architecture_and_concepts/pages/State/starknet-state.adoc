...
Cairo 1.0 classes that are part of the commitment are defined with Sierra, an intermediate representation between Cairo 1.0 and Cairo assembly (see xref:starknet_versions:upcoming_versions.adoc#_what_to_expect[here] for more information).
