...
Since xref:documentation:starknet_versions:version_notes.adoc#version0.10.1[StarkNet version 0.10
.1] the historical method of deploying accounts on StarkNet, the `deploy` transaction, has been removed.
