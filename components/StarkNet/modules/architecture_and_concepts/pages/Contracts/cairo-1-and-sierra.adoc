...
One of the reasons we chose to have an intermediate representation between user code and Casm is that it allows us to continue using the battle tested CairoVM.
====
