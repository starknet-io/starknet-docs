...
[NOTE]
====
The Cairo 0 compiler is no longer maintained, see link:https://github
.com/starkware-libs/cairo#compiling-starknet-contracts[here] for more details on Cairo 1 contracts
compilation.
====
:tabs-sync-option:
