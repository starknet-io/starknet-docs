...
[NOTE]
====
This is considered a lower level syntax for calling contracts. If the interface of the called
contract is available, then you can use a more straightforward syntax. For more information, see
the xref:documentation:getting_started:calling_contracts.adoc[Calling another contract] section in the
_Getting
Started_ tutorial.
====
