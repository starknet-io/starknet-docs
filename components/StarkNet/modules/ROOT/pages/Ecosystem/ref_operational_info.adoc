...
https://github.com/starknet-community-libs/starknet-addresses/blob/master/bridged_tokens/goerl2.json[`goerl2.json`^]:: The addresses of the tokens currently bridged to StarkNet testnet2.
