...
* xref:../Contracts/contract-classes.adoc[contract classes]: a mapping between class hash and the class definition
...
* stem:[$\text\{contract_hash}$] is the hash of the contract's definition discussed xref:../Contracts/contract-hash.adoc[here]
