...
This version introduces the next step in StarkNet's account abstraction design, specifically the validate/execute separation. For more information, see https://www.notion.so/starkware/StarkNet-0-10-0-4ac978234c384a30a195ce4070461257[here].
...
This version introduces the contract class/instance paradigm into StarkNet. For more information, see https://docs.starknet.io/documentation/architecture_and_concepts/Contracts/contract-classes/[here]
