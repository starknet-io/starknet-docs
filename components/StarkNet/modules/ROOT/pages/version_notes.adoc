...
Within StarkNet's deployment pipeline there are separate and distinct networks that operate independently of each other for testing before deployment. See https://docs.starknet.io/documentation/useful_info/[here] for more information. 


[id="versions"]
== Upcoming version (v0.10.3)

This is the currently deployed version on StarkNet Testnets. The Mainnet environment upgrade is planned for December 12.
...
This version introduces the next step in StarkNet's account abstraction design, specifically the validate/execute separation. For more information, see https://www.notion.so/starkware/StarkNet-0-10-0-4ac978234c384a30a195ce4070461257.
...
This version introduces the contract class/instance paradigm into StarkNet. For more information, see https://docs.starknet.io/documentation/architecture_and_concepts/Contracts/contract-classes/
