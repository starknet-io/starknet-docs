...
The fee itself is calculated in the xref:../Fees/fee-mechanism.adoc#overall-fee[same manner] as "regular" L2 transactions. You can use the xref:../CLI/commands.adoc#starknet-estimate_message_fee[CLI] to get an estimate of an L1 → L2 message fee.
