...
Within StarkNet's deployment pipeline there are seperate and distinct networks that operate independently of each other for testing before deployment. See xref:./index.adoc[here] for more information. 
